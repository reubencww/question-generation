...
def main(args, config):
    ...
    for epoch in range(0, config["max_epoch"]):
        ...
        (
            score_val_i2t,
            score_val_t2i,
        ) = evaluation(model_without_ddp, val_loader, device, config)
        score_test_i2t, score_test_t2i = evaluation(
            model_without_ddp, test_loader, device, config
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="./blip/configs/retrieval_flickr.yaml")
